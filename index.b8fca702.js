...
"use strict";
const Game = require("f85d15d21a3fd5b5");
const game = new Game();
...
function updateStatus() {
    if (game.getStatus() === Game.statuses.WIN) messageWin.classList.remove("hidden");
    else if (game.getStatus() === Game.statuses.LOSE) messageLose.classList.remove("hidden");
}
...
},{"f85d15d21a3fd5b5":"eIbh2"}],"eIbh2":[function(require,module,exports) {
class Game {
    static statuses = {
        IDLE: "idle",
        PLAYING: "playing",
